...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'BloggerBlogBundle', '/var/www/Symfony/app/Resources/BloggerBlogBundle/views', '/^[^.]+\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'BloggerBlogBundle', '/var/www/Symfony/src/Blogger/BlogBundle/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'))), 'twig');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('dbname' => 'symfony', 'host' => 'localhost', 'port' => '', 'user' => 'root', 'password' => 'gagh1988', 'driver' => 'pdo_mysql', 'driverOptions' => array()), $a, $b, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $d->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(new \Symfony\Bridge\Doctrine\Annotations\IndexedReader($this->get('annotation_reader')), array(0 => '/var/www/Symfony/src/Blogger/BlogBundle/Entity')), 'Blogger\\BlogBundle\\Entity');
    ...
    {
        return $this->services['form.csrf_provider'] = new \Symfony\Component\Form\Extension\Csrf\CsrfProvider\SessionCsrfProvider($this->get('session'), 'beef680ea1288a8342fd831ec5b8b264a4ce9cd6');
    }
    ...
    protected function getSwiftmailer_TransportService()
    {
        ...
        $instance->setUsername('gabriel8807');
        $instance->setPassword('gagh1988');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_user' => 'root',
            'database_password' => 'gagh1988',
            'mailer_transport' => 'gmail',
            'mailer_encryption' => 'ssl',
            'mailer_auth_mode' => 'login',
            'mailer_host' => 'smtp.gmail.com',
            'mailer_user' => 'gabriel8807',
            'mailer_password' => 'gagh1988',
            'locale' => 'en',
            'secret' => 'beef680ea1288a8342fd831ec5b8b264a4ce9cd6',
            ...
            'kernel.secret' => 'beef680ea1288a8342fd831ec5b8b264a4ce9cd6',
            ...
            'swiftmailer.transport.smtp.username' => 'gabriel8807',
            'swiftmailer.transport.smtp.password' => 'gagh1988',
